...
<template>
  <Layout>
    ...
    <view class="text-sm mt-4 text-[#0B1526]">
      请输入你在b（跳槽潜在回报）针对四个不同维度的重要性的权重比较和新offer与目前工作比较后得分。重要性权重总合为100%。取值在-1，1之间，1代表100%，没有100%完美的offer。
    </view>
    ...
    <view class="text-sm mt-8 text-[#0B1526]">
      请输入你在p（跳槽后潜在风险）针对四个不同维度的重要性的权重比较和新工作与目前工作适配度的打分。（适配度越高，无法存活风险越小）四个维度的重要性权重总和为100%。取值在-1，1之间，1代表100%，没有100%完美的offer。
    </view>
